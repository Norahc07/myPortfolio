...
const socialLinks = [
  {
    name: 'GitHub',
    href: 'https://github.com/Norahc07',
    icon: (props) => (
      <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
        <path
          fillRule="evenodd"
          d="M12 2C6.477 2 2 6.484 2 12.017c0 4.425 2.865 8.18 6.839 9.504.5.092.682-.217.682-.483 0-.237-.008-.868-.013-1.703-2.782.605-3.369-1.343-3.369-1.343-.454-1.158-1.11-1.466-1.11-1.466-.908-.62.069-.608.069-.608 1.003.07 1.531 1.032 1.531 1.032.892 1.53 2.341 1.088 2.91.832.092-.647.35-1.088.636-1.338-2.22-.253-4.555-1.11-4.555-4.943 0-1.091.39-1.984 1.029-2.683-.103-.253-.446-1.27.098-2.647 0 0 .84-.268 2.75 1.026A9.564 9.564 0 0112 6.844c.85.004 1.705.115 2.504.337 1.909-1.294 2.747-1.027 2.747-1.027.546 1.379.202 2.398.1 2.651.64.699 1.028 1.595 1.028 2.688 0 3.842-2.339 4.687-4.566 4.935.359.309.678.919.678 1.852 0 1.336-.012 2.415-.012 2.743 0 .267.18.578.688.48A10.019 10.019 0 0022 12.017C22 6.484 17.522 2 12 2z"
          clipRule="evenodd"
        />
      </svg>
    ),
  ...
  {
    name: 'LinkedIn',
    href: 'https://www.linkedin.com/in/luigi-amarillo-0a61a9276/',
    icon: (props) => (
      <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
  ...
  {
    name: 'Facebook',
    href: 'https://facebook.com/luigi.amarillo',
    icon: (props) => (
      <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
  ...
  {
    name: 'Instagram',
    href: 'https://instagram.com/iamluigiamarillo',
    icon: (props) => (
      <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
      ...
      <div className="container mx-auto px-4 md:px-6">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start space-x-3">
                <EnvelopeIcon className="h-5 w-5 text-primary mt-0.5 flex-shrink-0" />
              ...
              <li className="flex items-start space-x-3">
                ...
                <span className="text-gray-400">+63 977 083 7705</span>
              </li>
              <li className="flex items-start space-x-3">
                <MapPinIcon className="h-5 w-5 text-primary mt-0.5 flex-shrink-0" />
                <span className="text-gray-400">Mauban, Quezon</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-500 text-sm">
            &copy; {new Date().getFullYear()} Luigi Amarillo. All rights reserved.
          </p>
